...
var ErrTypeMismatch = errors.New("transaction type does not match category kind")
...
func (s *Service) Create(ctx context.Context, tx domain.Transaction) (domain.Transaction, error) { return s.txs.Create(ctx, tx) }
