...
- 🟡 Интеграционные gRPC‑тесты — частично: есть тесты Category с аутентификацией, добавлен сценарий Auth (Register→Login→Refresh→доступ к защищенным RPC), начаты сценарии Transaction+Report; дописать Tenant/Fx.
