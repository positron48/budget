...
- 🟡 Интеграционные gRPC‑тесты — частично: есть базовый тест Category с аутентификацией; добавить сценарии для Auth/Tenant/Transaction/Report.
...
- internal/adapter/grpc: 77.6% (нужно >= 80%) — добить интерцепторы/серверы дополнительными тестами.
...
Статус: ✅ сделано — сервер/репозиторий реализованы, unit‑тесты покрывают основные случаи.
...
Статус: ✅ сделано — usecase реализован, unit‑тесты есть; интеграцию можно расширить.
...
Статус: ✅ сделано — сервер/сервис реализованы; unit‑тесты на основные операции присутствуют.
